import { api, dateTime, duration, escapeHtml, fmt, money, renderDetail, table } from "../app.js";
  ...
  return `
    ...
    <section class="two-col">
      <div class="panel">${table([
        { label: "Time" }, { label: "Project" }, { label: "Models" }, { label: "Msgs", cls: "num" }, { label: "Tools", cls: "num" }, { label: "Agents", cls: "num" }, { label: "Cost", cls: "num" }, { label: "Duration", cls: "num" }, { label: "Last Prompt" },
      ], rows)}</div>
